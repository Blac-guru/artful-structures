export const SERVICES = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1560448204-e02f11c3d0e2?ixlib=rb-4.0.3&auto=format&fit=crop&w=400&h=300",
    link: "/portfolio",
  },
  {
    title: "Commercial",
  ...
  },
  {
    ...
    image:
      "https://images.pexels.com/photos/33534241/pexels-photo-33534241.jpeg",
    link: "/portfolio",
  },
  {
    ...
    image: "https://images.pexels.com/photos/7614405/pexels-photo-7614405.jpeg",
    link: "/portfolio",
  },
];
...
export const PORTFOLIO_PROJECTS = [
  ...
  },
  {
    ...
    description:
      "An elegant master bedroom designed as a personal sanctuary. The space features a custom upholstered headboard, luxury bedding, and carefully curated artwork. Warm ambient lighting creates a relaxing atmosphere, while the neutral color scheme with gold accents adds sophistication and timeless appeal.",
  ...
  },
  {
    ...
    description:
      "An open-concept kitchen that seamlessly blends functionality with style. Premium materials including marble countertops and custom cabinetry create a luxurious feel, while smart storage solutions maximize efficiency. The design incorporates modern appliances and thoughtful lighting to create the perfect space for cooking and entertaining.",
  ...
  },
  {
    ...
    description:
      "A dynamic workspace design that promotes collaboration and productivity. The office features modern furniture, innovative layout solutions, and sophisticated color schemes that create an inspiring work environment. Natural light and biophilic design elements enhance employee wellbeing and satisfaction.",
  ...
  },
  {
    ...
    description:
      "A premium retail environment designed to enhance the customer experience. The showroom features sophisticated product displays, strategic lighting, and luxurious finishes that create an aspirational shopping atmosphere. Every detail is carefully considered to reflect the brand's premium positioning.",
...
export const COMPANY_VALUES = [
  {
    title: "Innovation",
    description:
      "We continuously explore new design trends, materials, and technologies to create cutting-edge solutions.",
    icon: "lightbulb",
  },
  {
    title: "Passion",
    description:
      "Every project is infused with genuine enthusiasm and dedication to creating extraordinary spaces.",
    icon: "heart",
  },
  {
    title: "Excellence",
    description:
      "We maintain the highest standards of quality in every detail, from concept to completion.",
    icon: "check-circle",
  },
];
