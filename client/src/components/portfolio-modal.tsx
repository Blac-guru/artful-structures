      ...
      <DialogContent className="max-w-4xl w-full max-h-[90vh] overflow-y-auto p-0" data-testid="modal-portfolio">
        ...
        <div className="p-8">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-6">
            <div>
              <h4 className="font-semibold text-charcoal-800 mb-4">Project Details</h4>
            ...
            <div>
              <h4 className="font-semibold text-charcoal-800 mb-4">About This Project</h4>
              <div className="text-charcoal-600 leading-relaxed" data-testid="text-modal-description">
                {project.description}
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-cream-300 pt-6 text-center">
            ...
            <p className="text-charcoal-600 mb-6">
              Get a personalized quote for a similar project tailored to your space and style.
            </p>
